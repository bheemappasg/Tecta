...
public class Compaign {
	...
	public void DropDown(String visibleTesxt) throws InterruptedException
	{
		Thread.sleep(1000);
		Select s =new Select(Property);
		 
		s.selectByVisibleText(visibleTesxt);
		
	}
	public void DropDown1(String visibleTesxt2) throws InterruptedException
	{
		Thread.sleep(1000);
		Select s1 =new Select(PropertyStatus);
		s1.selectByVisibleText(visibleTesxt2);
	}
